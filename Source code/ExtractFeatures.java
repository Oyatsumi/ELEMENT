...
/*
Please use the features that are described solely on the paper
This code does not contain the region-growing pixel-classification, it just extracts the features used in the work
*/
